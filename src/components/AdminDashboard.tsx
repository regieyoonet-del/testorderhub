...
export default function AdminDashboard({
  ...
  const handleToggleProductAllocation = (productId: string) => {
    ...
    let currentList = selectedAllocCompany.enabledProductIds || products.map(p => p.id);
          ...
          {showClientForm ? (
            <form onSubmit={handleSaveClientSubmit} className="bg-white border border-gray-200 rounded-3xl p-6 md:p-8 shadow-md space-y-6 max-w-2xl animate-slide-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Company Logo (URL, base64, or attach below)</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Portal Login Username * (lowercase)</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Portal Passcode *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Buyer Contact Person</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Buyer Corporate Email</label>
                  <input
                    type="email"
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] uppercase font-mono tracking-wider font-bold text-gray-700">Buyer Office Phone</label>
                  <input
                    type="text"
