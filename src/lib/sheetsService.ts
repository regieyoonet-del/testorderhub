    ...
    try {
      ...
      if (raw.adminSettings && typeof raw.adminSettings === 'object') {
        ...
        adminSettings = {
          ...
          pwaIconUrl: getProp(item, ['PwaIconURL', 'PWA Icon URL', 'pwaIconUrl', 'PwaIconUrl', 'pwaIcon']),
          pwaIcon192Url: getProp(item, ['PwaIcon192URL', 'PWA Icon 192 URL', 'pwaIcon192Url', 'pwaIcon192']),
          pwaIcon512Url: getProp(item, ['PwaIcon512URL', 'PWA Icon 512 URL', 'pwaIcon512Url', 'pwaIcon512']),
          pwaIconMaskableUrl: getProp(item, ['PwaIconMaskableURL', 'PWA Icon Maskable URL', 'pwaIconMaskableUrl', 'pwaIconMaskable']),
